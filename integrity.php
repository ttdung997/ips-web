            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid-header">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Kiểm tra tính toàn vẹn</h1>

                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="/"><i class="fa fa-home" aria-hidden="true"></i> Trang chủ</a></li>
                                    <li class="breadcrumb-item active">Kiểm tra tính toàn vẹn</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<div class="row">
            ...
            <button id="button1" type="button" class="btn btn-add" onclick="add()" style="margin-right: 10px;"><i class="fa fa-plus" aria-hidden="true"></i> Thêm đường dẫn </button>
             <button id="button2" type="button" class="btn btn-add" onclick="addHash()" style="margin-right: 10px;><i class="fa fa-barcode" aria-hidden="true"></i> Bắm tệp</button>
             <button id="button3" type="button" class="btn btn-add" onclick="addXML()" style="margin-right: 10px;><i class="fa fa-plus" aria-hidden="true"></i> Thêm tệp XML </button>
          </div>

              </div>
              <div class="col-sm-7">

                <h5>Danh sách tệp bảo vệ </h5>
                   <div  id="list_error"  style="border: 1px solid #585858; border-radius: 5px; max-height: 500px;min-height: 500px;  overflow-y: auto; background-color: #00000045;padding: 10px;">
                    ...
                    <div class="row float-right" style="margin: 10px 0px 10px 10px;">
...
data.append('path', path);
  ...
  $.ajax({ 
  method: "POST",
  url: "/php/intergrity_addhash.php",
  data: data,
  processData: false,
  contentType: false,
    async: false,
   ...
   success: function (data) {
    ...
    data = JSON.parse(data)["hash_str"];

    alert("Dạng băm của tệp: "+data);
...
data.append('path', path);
  ...
  contentType: false,
   ...
   success: function (data) {
    ...
    if(data != false){
      alert("Đã thêm tệp XML thành công");
    }else{
      alert("Không đúng định dạng XML")
    }
  loadPath();
   }
