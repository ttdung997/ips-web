...
def check():
	# print ''
	# print ' Remove Default CGI Content printenv '.center(85, '#')
	# print ''
	...
	if obj[0] != 0:
		f = os.popen('find '+obj[0]+' -name printenv')
		find_result = f.read()
		f.close()
		if len(find_result) != 0:
			error_list.append('[WARNING] Detect the printenv default CGI in cgi-bin directory')
			error_list.insert(0, 21)
		else:
