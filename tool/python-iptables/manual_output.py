...
def main():
	...
	group.add_argument('-I','--insert', type=int, default=0, help="""Insert rule in position. Default is location 0, the packet will face this rule first.
	...
	if args.delete >= 0 and args.delete != None:
