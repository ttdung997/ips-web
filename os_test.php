            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid-header">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Kiểm thử và đánh giá hệ điều hành</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="/"><i class="fa fa-home" aria-hidden="true"></i> Trang chủ</a></li>
                                    <li class="breadcrumb-item active">Kiểm thử và đánh giá hệ điều hành</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    function checkErrors(){
        var urlInput = "php/check_linux.php";
        var totalError = "213";
  $.ajax({ 
    method:"GET", 
    url: urlInput,
...
function fixErrors(){
  ...
  array.push($(this).attr("data-id"));
    ...
    var urlInput = "php/fixlinux.php";
    alert('Các lỗ hổng hệ điều hành không hỗ trợ tự động sửa!!!');
    return;
