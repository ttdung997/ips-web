...
?>
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid-header">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1>Kiểm thử và đánh giá phần mềm cung cấp dịch vụ công</h1>
                            </div>
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item"><a href="/"><i class="fa fa-home" aria-hidden="true"></i> Trang chủ</a></li>
                                    <li class="breadcrumb-item active">Kiểm thử và đánh giá dịch vụ công</li>
                                </ol>
                            </div>
                        </div>
                    </div>
      ...
      <!--   <label style="margin-left:40px; margin-top:10px;" for="ip">Loại lỗ hổng: </label>
        <select id="CheckType" style="margin-left:20px; width: 15%;color: wheat;" class="form-control-custom-size"  onchange="clearFun()">
    ...
    <div class="row float-right" style="padding-bottom: 30px; margin-right: 20px;">
        ...
        <div class="" style="padding: 0 0 0 15px;">
         ...
         <!-- <div class="" style="padding: 0 0 0 15px;">
            <button id="button2" type="button" class="btn btn-add" onclick="save()"><i class="fa fa-chain-broken"></i> Lưu lịch sử </button>
        </div> -->
...
<script type="text/javascript">
    ...
    // console.log(urlsType)

        var urlInput = "php/check_apache.php";
        var totalError = "54";
...
function fixErrors(){
  ...
  array.push($(this).attr("data-id"));
    ...
    var urlInput = "php/fixapache.php";
